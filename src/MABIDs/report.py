...
ANALYTE_CHOICES: Final[List[str]] = ["alkalinity", "bisulfite", "chloride", "emulsion", "experimental", "iron2", "iron32d", "ph", "phosphate", "redox", "sulfate", "suspended", "total_iron"]
DEFAULT_ANALYTE: Final[str] = AnalyteName.ALKALINITY
...
DEFAULT_SAMPLES_BASE_DIRS: Final[Dict[str, List[str]]] = {
    AnalyteName.ALKALINITY: [
      ...
      r"G:\Dataset\Alkalinity\validacao\AlkalinityCellphoneVariation\CR11, A0"
    ...
    AnalyteName.TOTAL_IRON: [
       #os.path.join(DATASET_ROOT, "MABIDs-Dataset-Total_iron", "train")
       f"G:\\DAVID\\TotalIron"
    ],
...
DEFAULT_SKIP_BLANK_SAMPLES: Final[bool] = False
...
DEFAULT_CHECKPOINT: Final[Dict[str, str]] = {
    ...
    "sulfate2d": sulfate2d.NETWORK_CHECKPOINT,
    ...
    "total_iron": total_iron.NETWORK_CHECKPOINT,
}
...
DEFAULT_PCA_STATS: Final[Dict[str, str]] = {
   ...
   # "ph": ph.PCA_STATS,
    "sulfate2d": sulfate2d.PCA_STATS,
    "suspended": suspended.PCA_STATS,
    "total_iron": total_iron.PCA_STATS,
}
...
def main(args: Namespace) -> None:
    ...
    try:
        ...
        elif args.analyte == "sulfate2d":
            estimation_func_class = sulfate2d.Sulfate2DEstimationFunction
            sample_dataset_class = sulfate2d.Sulfate2DSampleDataset
            processed_sample_dataset_class = sulfate2d.ProcessedSulfate2DSampleDataset
        ...
        elif args.analyte == "total_iron":
            estimation_func_class = total_iron.TotalIronEstimationFunction
            sample_dataset_class = total_iron.TotalIronSampleDataset
            processed_sample_dataset_class = total_iron.ProcessedTotalIronSampleDataset
        else:
            raise NotImplementedError
        # Load PCA statistics.
