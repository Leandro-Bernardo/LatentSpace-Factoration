...
DEFAULT_WANDB_SWEEP_NAME: Final[Optional[str]] = "(New PCA) Decoder (dist2dist) dataset (cellphone samples) (14-01-26)" if DEFAULT_WANDB_SWEEP_ID is None else None
...
GENERATOR_NETWORK_CHOICES: Dict[str, AnalyteUpClasses] = {
    ...
    **{name: AnalyteUpClasses(analyte=AnalyteName.SULFATE2D, network_class=obj, sample_dataset_class=sulfate2d.Sulfate2DSampleDataset, processed_sample_dataset_class=sulfate2d.ProcessedSulfate2DSampleDataset) for name, obj in inspect.getmembers(sulfate2d) if inspect.isclass(obj) and issubclass(obj, sulfate2d.Sulfate2DUpNetwork) and obj != sulfate2d.Sulfate2DUpNetwork},
    **{name: AnalyteUpClasses(analyte=AnalyteName.IRON2, network_class=obj, sample_dataset_class=iron2.Iron2SampleDataset, processed_sample_dataset_class=iron2.ProcessedIron2SampleDataset) for name, obj in inspect.getmembers(iron2) if inspect.isclass(obj) and issubclass(obj, iron2.Iron2UpNetwork) and obj != iron2.Iron2UpNetwork},
}

DEFAULT_ORACLE_CLASS: Final[Type[Network]] = sulfate2d.Sulfate2DNetworkVgg11Style
DEFAULT_GENERATOR_CLASS: Final[Type[Network]] = sulfate2d.Sulfate2DNetworkUpVgg11Style
...
DEFAULT_ORACLE_CHECKPOINT: Final[Dict[str, str]] = {
    ...
    AnalyteName.SULFATE2D: sulfate2d.NETWORK_CHECKPOINT,
...
DEFAULT_GENERATOR_CHECKPOINT: Final[Dict[str, str]] = {
    ...
    AnalyteName.SULFATE2D: sulfate2d.UPNETWORK_CHECKPOINT,
...
DEFAULT_FIT_SAMPLES_BASE_DIRS: Final[Dict[str, List[str]]] = {
    ...
    AnalyteName.IRON2: [
        os.path.join(DATASET_ROOT, "MABIDs-Dataset-Iron2", "train")
        ],
    AnalyteName.IRON3: [],
...
DEFAULT_ARTIFICIAL_VALUES_DISTRIBUTION: Final[str] = Dist2DistArtificialValues.EQUIDISTANT
DEFAULT_REAL_DATA_PERCENT: Final[float] = 1.0 # from 0 to 1
DEFAULT_ARTIFICIAL_DATA_PERCENT: Final[float] = 3.0 # from 0 to 1 EQUIDISTANCE works with intagers and RANDOM with floats
