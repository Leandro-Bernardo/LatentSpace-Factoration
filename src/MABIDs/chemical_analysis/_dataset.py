...
from .typing import App, AuxiliarySolution, AuxiliarySolutionComponent, ChamberType, Device, Sample, SolutionComponent, Stock, StockAliquot, WhiteBalanceType
...
class ProcessedSampleDataset(SizedDataset[ProcessedSample]):
    ...
    @abstractmethod
    def _whitebalance_type(self) -> WhiteBalanceType:
        raise NotImplementedError  # To be implemented by the subclass.
