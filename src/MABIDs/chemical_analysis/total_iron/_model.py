...
class TotalIronNetwork(ContinuousNetwork):
...
class TotalIronIntervalNetworkSqueezeNetStyle(TotalIronIntervalNetwork):
...
class TotalIronEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(TotalIronNetwork, **kwargs)
