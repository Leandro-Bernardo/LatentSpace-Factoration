...
class Sulfate2DSampleDataset(SampleDataset):
    ...
    def _parse_values(self, raw_sample: Dict[str, Any]) -> Tuple[Optional[float], Optional[float], str]:
        return (
            ...
            raw_sample["sourceStock"].get("sulfateConcentrationUnit", "MILLIGRAM_PER_LITER_OF_BISULFITE"),
        )


class ProcessedSulfate2DSampleDataset(ProcessedSampleDataset):
