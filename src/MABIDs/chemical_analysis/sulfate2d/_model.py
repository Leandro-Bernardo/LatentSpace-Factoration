...
class Sulfate2DNetwork(ContinuousNetwork):
...
class Sulfate2DUpNetwork(ContinuousUpNetwork):
    def __init__(self, backbone: Module, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self.model = torch.nn.Sequential(OrderedDict([
            ("backbone", backbone),
...
class Sulfate2DIntervalNetworkSqueezeNetStyle(Sulfate2DIntervalNetwork):
...
class Sulfate2DNetworkUpVgg11Style(Sulfate2DUpNetwork):
...
class Sulfate2DEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(Sulfate2DNetwork, **kwargs)
